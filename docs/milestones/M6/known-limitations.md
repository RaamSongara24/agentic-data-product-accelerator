...
4. **No adapter HTTP API** — export is a library boundary callable from tests/tools; UI wiring is optional later.
5. **No M7 demo script / DoD walkthrough** — orchestrator asks PO before M7.
